...
from vibe_check.mentor.mcp_sampling import MCPSamplingClient, SamplingConfig, CircuitBreaker
...
class TestMCPSamplingIntegration:
    ...
    @pytest.mark.asyncio
    async def test_dynamic_generation_with_mcp(self, mentor_engine, mock_ctx, test_session):
    ...
    async def test_secret_redaction(self, mentor_engine, mock_ctx):
        ...
        # Query with secrets
        query_with_secrets = "My API key is sk-1234567890abcdef and password is supersecret123"
    ...
    @pytest.mark.asyncio
    async def test_prompt_length_enforcement(self, mentor_engine, mock_ctx, test_session):
    ...
    async def test_hybrid_routing_decisions(self, mentor_engine):
        ...
        test_cases = [
            ...
            ("Implement ESLint hybrid automation", "implementation", RouteDecision.DYNAMIC),
            ("Debug memory leak in our custom WebAssembly module", "debugging", RouteDecision.DYNAMIC),
        ]
