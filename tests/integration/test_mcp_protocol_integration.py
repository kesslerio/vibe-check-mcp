...
class TestMCPProtocolIntegration:
    ...
    def test_mcp_response_serialization(self):
        ...
        for text in test_cases:
            ...
            try:
                ...
                pytest.fail(f"Response not MCP-serializable for input '{text[:50]}...': {e}")
    ...
    async def test_concurrent_mcp_tool_calls(self):
        ...
        tasks = [
            async_tool_call(f"Concurrent analysis {i}")
            for i in range(5)
        ]
    ...
    def test_mcp_resource_usage_limits(self):
        ...
        assert duration < 30.0, f"Tool execution exceeded reasonable MCP timeout: {duration}s"
