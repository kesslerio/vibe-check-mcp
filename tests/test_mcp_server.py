...
class TestMCPServerIntegration:
    ...
    def test_demo_tool_integration(self):
        ...
        test_text = (
            "We should build our own custom HTTP client instead of using the SDK"
        )
        ...
        assert (
            result["demo_analysis"]["analysis_method"]
            == "Phase 1 validated core engine"
        )
    ...
    def test_server_status_tool(self):
        ...
        assert status["server_name"] == "Vibe Check MCP"
    ...
    def test_server_import(self):
        ...
        from vibe_check.server import mcp, run_server
    ...
    @patch("vibe_check.server.mcp.run")
    ...
    def test_module_structure(self):
        ...
        from vibe_check import PatternDetector, EducationalContentGenerator, run_server
        ...
        # Test tools module
        from vibe_check.tools import demo_analyze_text
