...
class TestResponseStrategies:
    ...
    def test_strategy_manager_priority(self):
        ...
        response_type, content, confidence = manager.generate_response(tech_context, [], query)
...
class TestIntegration:
    ...
    def test_performance_with_large_input(self):
        ...
        large_query = "I'm considering React Vue Angular Django FastAPI Express Rails Svelte " * 20
...
class TestPerformance:
    ...
    def test_strategy_selection_performance(self):
        ...
        start_time = time.time()
        for _ in range(1000):
            manager.generate_response(tech_context, [], "How to use React with PostgreSQL?")
        end_time = time.time()
