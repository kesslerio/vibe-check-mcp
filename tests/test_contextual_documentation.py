...
class TestLibraryDetectionEngine:
    ...
    def mock_config(self):
        ...
        config.context_loading.library_detection.exclude_patterns = ['node_modules', '__pycache__']
    ...
    def detection_engine(self, mock_config):
        ...
        with patch('src.vibe_check.tools.contextual_documentation.Path.open', mock_open(read_data='{}')):
...
def read_root():
    return {"Hello": "World"}
"""
        result = detection_engine.detect_libraries_from_content(content, "main.py", ".py")
...
"""
        result = detection_engine.detect_libraries_from_content(content, "Component.tsx", ".tsx")
    ...
    def test_detect_libraries_from_dependencies_requirements_txt(self, detection_engine):
...
"""
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(doc_parser, '_load_integration_knowledge_base', 
