...
class TestAnalyzeTextTool:
    ...
    def test_unicode_text_handling(self):
        ...
        unicode_text = (
            "We need custom 🚀 implementation with émojis and spéciál chars αβγδ"
        )
    ...
    def test_context_integration(self):
        ...
        result_with_context = analyze_text_demo(
            text, use_project_context=True, project_root="."
        )

        # Test without context
        result_without_context = analyze_text_demo(text, use_project_context=False)
    ...
    def test_project_root_parameter(self):
        ...
        for root in test_roots:
            result = analyze_text_demo(
                text, project_root=root, use_project_context=True
            )
