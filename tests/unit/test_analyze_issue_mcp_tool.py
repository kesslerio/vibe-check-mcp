...
class TestAnalyzeIssueMCPTool:
    ...
    def test_analyze_issue_response_structure_validation(self):
        ...
        with patch('vibe_check.tools.analyze_issue.get_vibe_check_framework') as mock_get_framework:
            ...
            required_fields = [
                "status", "analysis_timestamp", "vibe_check", 
                "issue_info", "technical_analysis", "enhanced_features", 
                "analysis_metadata"
            ]
            ...
            vibe_check = result["vibe_check"]
            vibe_check_fields = [
                "overall_vibe", "vibe_level", "friendly_summary", 
                "coaching_recommendations"
            ]
            ...
            issue_info = result["issue_info"]
            issue_info_fields = [
                "number", "repository", "analysis_mode", 
                "detail_level", "comment_posted"
            ]
