...
- Custom auth required for compliance"""
    ...
    def _create_pattern_exceptions_file(self) -> None:
        ...
        exceptions = {
            ...
            "reasoning": {
                "custom-auth-pattern": "Required for GDPR compliance"
            }
        }
    ...
    @patch('src.vibe_check.tools.shared.claude_integration.ClaudeCliExecutor._get_claude_args')
    def test_get_claude_args_with_context_injection(self, mock_parent_get_claude_args):
        ...
        result_args = self.executor._get_claude_args(original_prompt, "code_analysis", "sonnet")
    ...
    @patch('src.vibe_check.tools.shared.claude_integration.ClaudeCliExecutor._get_system_prompt')
    def test_get_system_prompt_with_context_injection(self, mock_parent_get_system_prompt):
    ...
    def test_inheritance_compatibility(self):
        ...
        parent_methods = ['execute_sync', 'execute_async', '_find_claude_cli', '_get_mcp_config_path']
...
- Legacy components allowed during migration phase"""
        ...
        mock_subprocess.return_value = Mock(
            returncode=0,
            stdout="Context-aware analysis result",
            stderr=""
        )
