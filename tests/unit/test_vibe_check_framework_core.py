...
class TestVibeCheckFrameworkCore:
    ...
    def test_determine_vibe_level_infrastructure_pattern(
        self, framework, sample_detection_results
    ):
    ...
    def test_generate_coaching_recommendations_no_patterns(self, framework):
        ...
        assert len(recommendations) > 0
        assert any(
            "keep up" in rec.lower() or "great" in rec.lower()
            for rec in recommendations
        )

    def test_generate_coaching_recommendations_brief_level(
        self, framework, sample_detection_results
    ):
        """Test coaching recommendations with brief detail level"""
        recommendations = framework._generate_coaching_recommendations(
            sample_detection_results, DetailLevel.BRIEF
        )
    ...
    def test_generate_coaching_recommendations_comprehensive_level(
        self, framework, sample_detection_results
    ):
        """Test coaching recommendations with comprehensive detail level"""
        recommendations = framework._generate_coaching_recommendations(
            sample_detection_results, DetailLevel.COMPREHENSIVE
        )
    ...
    def test_create_vibe_check_result(
        self, framework, sample_issue_data, sample_detection_results
    ):
