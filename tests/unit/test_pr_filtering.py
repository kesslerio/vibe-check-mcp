...
class TestShouldUseLLMAnalysis:
    ...
    def test_small_pr_uses_llm(self):
        ...
        pr_data = {"additions": 50, "deletions": 20, "changed_files": 3}
    ...
    def test_large_pr_lines_skips_llm(self):
        ...
        assert (
            f"Large PR: 1100 lines changed (threshold: {FilteringConfig.MAX_LINES_FOR_LLM})"
            in result.reason
        )
    ...
    def test_many_files_skips_llm(self):
        ...
        pr_data = {"additions": 400, "deletions": 200, "changed_files": 25}
...
class TestCreateLargePRResponse:
    ...
    def test_large_pr_response_structure(self):
        ...
        pr_data = {"number": 123, "title": "Large refactoring PR"}
...
class TestAnalyzeWithFallback:
    ...
    async def test_small_pr_uses_llm_successfully(self):
        ...
        result = await analyze_with_fallback(
            pr_data=pr_data, llm_analyzer_func=llm_func, fast_analyzer_func=fast_func
        )
    ...
    async def test_llm_failure_fallback(self):
        ...
        pr_data = {"additions": 200, "deletions": 100, "changed_files": 8}
