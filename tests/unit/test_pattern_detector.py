...
class TestPatternDetector:
    ...
    def test_documentation_neglect_detection(self, detector):
        ...
        text = "I couldn't find how to use the API properly, so I'll build my own solution"
    ...
    def test_detail_level_parameter(self, detector):
        ...
        for detail_level in [DetailLevel.BRIEF, DetailLevel.STANDARD, DetailLevel.COMPREHENSIVE]:
            results = detector.analyze_text_for_patterns(text, detail_level=detail_level)
            assert isinstance(results, list)
    ...
    def test_context_parameter(self, detector):
        ...
        # Test with context
        results_with_context = detector.analyze_text_for_patterns(content, context=context)
