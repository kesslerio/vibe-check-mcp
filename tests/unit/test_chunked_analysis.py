...
class TestPrSizeClassifier:
    ...
    def test_small_pr_classification(self):
        ...
        pr_data = {"additions": 200, "deletions": 100, "changed_files": 5}
    ...
    def test_medium_pr_classification(self):
        ...
        pr_data = {"additions": 500, "deletions": 200, "changed_files": 15}
    ...
    def test_large_pr_classification(self):
        ...
        pr_data = {"additions": 800, "deletions": 400, "changed_files": 25}
    ...
    def test_edge_case_thresholds(self):
        ...
        small_edge_data = {"additions": 500, "deletions": 0, "changed_files": 10}

        metrics = classifier.classify_pr(small_edge_data)
        assert metrics.size_category == PrSizeCategory.SMALL

        # Just over SMALL threshold
        medium_edge_data = {"additions": 501, "deletions": 0, "changed_files": 10}
    ...
    def test_chunking_recommendations(self):
        ...
        small_metrics = PrSizeMetrics(
            ...
            deletions=100,
            changed_files=5,
            lines_per_file_avg=60,
            largest_file_changes=80,
            files_per_change_ratio=0.017,
            size_category=PrSizeCategory.SMALL,
            analysis_strategy="full_llm_analysis",
            estimated_chunks=1,
        ...
        medium_metrics = PrSizeMetrics(
            ...
            deletions=250,
            changed_files=15,
            lines_per_file_avg=50,
            largest_file_changes=120,
            files_per_change_ratio=0.02,
            size_category=PrSizeCategory.MEDIUM,
            analysis_strategy="chunked_llm_analysis",
            estimated_chunks=2,
            has_large_files=False,
            has_many_small_changes=False,
...
class TestChunkedAnalyzer:
    ...
    def setup_method(self):
        ...
        self.analyzer = ChunkedAnalyzer(
            chunk_timeout=30, max_concurrent_chunks=2, max_lines_per_chunk=100
        )
    ...
    def test_chunk_analysis_prompt_building(self):
        ...
        pr_data = {"title": "Test PR", "body": "This is a test PR description"}
    ...
    async def test_successful_chunked_analysis(self):
        ...
        with patch(
            "src.vibe_check.tools.shared.claude_integration.analyze_content_async_with_circuit_breaker"
        ) as mock_claude:
    ...
    async def test_partial_failure_chunked_analysis(self):
        ...
        with patch(
            "src.vibe_check.tools.shared.claude_integration.analyze_content_async_with_circuit_breaker",
            side_effect=mock_claude_analysis,
        ):
            result = await self.analyzer.analyze_pr_chunked(pr_data, pr_files)
    ...
    def test_pattern_deduplication(self):
        ...
        performance_patterns = [
            p for p in unique_patterns if p["category"] == "performance"
        ]
    ...
    def test_recommendation_prioritization(self):
        ...
        assert any(
            "error" in rec.lower() or "fix" in rec.lower() for rec in prioritized[:2]
        )
    ...
    def test_overall_assessment_creation(self):
        ...
        pr_metrics = PrSizeMetrics(
            ...
            deletions=60,
            changed_files=3,
            lines_per_file_avg=53,
            largest_file_changes=60,
            files_per_change_ratio=0.019,
            size_category=PrSizeCategory.MEDIUM,
            analysis_strategy="chunked_llm_analysis",
            estimated_chunks=3,
            has_large_files=False,
        ...
        assessment = self.analyzer._create_overall_assessment(
...
class TestIntegration:
    ...
    async def test_convenience_function(self):
        ...
        pr_files = [{"filename": f"file{i}.py", "changes": 70} for i in range(8)]

        with patch(
            "src.vibe_check.tools.shared.claude_integration.analyze_content_async_with_circuit_breaker"
        ) as mock_claude:
            mock_claude.return_value = Mock(
                success=True, output="**Summary**: Good analysis"
            )
            ...
            assert result.status in [
                "chunked_analysis_complete",
                "chunked_analysis_partial",
            ]
    ...
    async def test_timeout_handling(self):
        ...
        with patch(
            "src.vibe_check.tools.shared.claude_integration.analyze_content_async_with_circuit_breaker",
            side_effect=slow_claude_analysis,
        ):
