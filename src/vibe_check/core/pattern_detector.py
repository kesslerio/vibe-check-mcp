...
class PatternDetector:
        ...
        for pattern_id, pattern_config in self.patterns.items():
            ...
            if result.detected:
                ...
                result.educational_content = self._generate_educational_content(
                    pattern_id, result, detail_level
                )
    ...
    def detect_infrastructure_without_implementation(
        ...
        if result.detected:
            result.educational_content = self._generate_educational_content(
                "infrastructure_without_implementation", result, detail_level
            )
    ...
    def _get_why_problematic(self, pattern_id: str) -> str:
        ...
        return explanations.get(
            pattern_id,
            "This pattern can lead to technical debt and maintenance issues.",
        )
    ...
    def _get_remediation_steps(self, pattern_id: str) -> List[str]:
        ...
        return remediation_steps.get(
            pattern_id, ["Review the approach and consider alternatives"]
        )
