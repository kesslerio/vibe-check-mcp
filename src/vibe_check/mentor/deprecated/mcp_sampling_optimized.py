    ...
    try:
        ...
        if original_generate:
            ...
            async def fast_generate_dynamic_response(
                ...
                if workspace_data:
                    is_valid, error, sanitized_ws = validate_workspace_fast(
                        workspace_data
                    )
                    if not is_valid:
                        ...
                        if "code" in workspace_data:
                            workspace_data["code"], _ = (
                                FastSecretsScanner.scan_and_redact(
            ...
            original.MCPSamplingClient.generate_dynamic_response = (
                fast_generate_dynamic_response
            )
