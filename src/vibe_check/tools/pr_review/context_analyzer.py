...
class ReviewContextAnalyzer:
    ...
    def detect_re_review(self, pr_data: Dict[str, Any], force_re_review: bool = False) -> Dict[str, Any]:
        """
        ...
        if is_re_review:
            self.logger.info(f"🔄 Re-review detected: {review_count} previous automated reviews found")
        else:
    ...
    def extract_review_history_summary(self, previous_reviews: list) -> str:
        ...
        automated_reviews = [
            review for review in previous_reviews
        ...
        for i, review in enumerate(automated_reviews[-3:], 1):  # Show last 3 reviews
            ...
            body_preview = review.get("body", "")[:100] + "..." if len(review.get("body", "")) > 100 else review.get("body", "")
