...
class RetryConfig:
    ...
    retryable_exceptions: tuple = (ClaudeCliError, asyncio.TimeoutError, ConnectionError)
...
class RetryExecutor:
    ...
    def __init__(
        ...
        self.strategy = strategy or ExponentialBackoffStrategy(self.config.jitter_factor)
        ...
        **kwargs
        ...
        for attempt in range(self.config.max_retries + 1):
            try:
                ...
                ) if attempt < self.config.max_retries else 0
