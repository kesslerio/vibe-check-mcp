    ...
    async def analyze_issue_hybrid(
        ...
        try:
            ...
            combined_result = {
                ...
                "hybrid_summary": self._generate_hybrid_summary(
    ...
    try:
        ...
        if post_comment:
            try:
                ...
                detail_enum = (
                    DetailLevel(detail_level.lower())
                    if detail_level.lower() in ["brief", "standard", "comprehensive"]
