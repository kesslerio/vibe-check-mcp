    ...
    try:
        ...
        return {
            ...
            "instructions": {
                ...
                "estimated_completion": status_info.get("timing", {}).get("estimated_completion_timestamp"),
...
async def check_analysis_status(job_id: str) -> Dict[str, Any]:
    ...
    if not await initialize_async_system():
        return {
            "status": "error",
            "error": "Async analysis system not available"
        }
...
def _generate_immediate_analysis(pr_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "review_strategy": {
            ...
            "focus_areas": ["breaking_changes", "security_implications", "performance_impact"],
