...
from vibe_check.tools.doom_loop_analysis import (
    ...
    reset_session_tracking as reset_session,
)
...
def analyze_doom_loops(
    ...
    try:
        ...
        text_analysis = analyze_text_for_doom_loops(
            content, context, "analyze_doom_loops"
        )
        ...
        overall_severity = max(
            severity_scores.get(text_severity, 0),
            severity_scores.get(session_severity, 0),
        )
