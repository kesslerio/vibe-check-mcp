...
class PatternValidator:
    ...
    def __init__(self, schema_path: str = None):
        ...
        if schema_path is None:
            ...
            schema_path = current_dir.parent.parent.parent / "data" / "pattern_schema.json"
    ...
    def validate_single_pattern(self, pattern_id: str, pattern_def: Dict[str, Any]) -> Tuple[bool, List[str]]:
        """
