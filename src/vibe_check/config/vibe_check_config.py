...
class VibeCheckConfigLoader:
    ...
    def load_config(self) -> VibeCheckConfig:
        ...
        if not self.config_file.exists():
            logger.info(f"No .vibe-check/config.json found at {self.config_file}, using defaults")
    ...
    def create_default_config(self) -> None:
        ...
        default_config = {
            "context_loading": {
                ...
                "project_docs": {
                    "paths": ["docs/", "README.md", "CONTRIBUTING.md", "ARCHITECTURE.md"],
    ...
    if not exceptions_file.exists():
        default_exceptions = {
            ...
            "temporary_exceptions": [
                "migration-phase-mixed-patterns"
            ],
            "reasoning": {
