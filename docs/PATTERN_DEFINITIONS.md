...
This document provides comprehensive guidance for defining anti-patterns in the Anti-Pattern Coach detection system. All pattern definitions are stored in `data/anti_patterns.json` and must conform to the JSON schema defined in `data/pattern_schema.json`.
...
- [Anti-Pattern Coach Core Documentation](Technical_Implementation_Guide.md)
